...
%>
	<body>
		...
		<form action="/createEquipmentType" method="post" id="equipmentTypeForm">
			<b>Equipment Description: Vehicle</b><br><br>
			...
			<input type="hidden" name="propertyType1" value="Short Text">
			...
			<input type="hidden" name="propertyType2" value="Short Text">
			...
			Property #3 Options: Days,Weeks,Months,Years<br>
			...
			<input type="hidden" name="propertyType5" value="Short Text">
			...
			<input type="hidden" name="propertyType6" value="Short Text">
			...
			Property #7 Options: Days,Weeks,Months,Years<br>
			...
			<input type="hidden" name="propertyType9" value="Short Text">
			...
			<input type="hidden" name="propertyType10" value="Short Text">
			...
			Property #11 Options: Days,Weeks,Months,Years<br>
			...
			<input type="hidden" name="propertyType13" value="Short Text">
			...
			<input type="hidden" name="propertyType14" value="Short Text">
			...
			Property #15 Options: Days,Weeks,Months,Years<br>
			...
			Property #17 Description: Tire Pressure<br>
			<input type="hidden" name="propertyDescription17" value="Tire Pressure">
			Property #17 Type: Short Text<br>
			<input type="hidden" name="propertyType17" value="Short Text">
			Property #17 Options: N/A<br>
			<input type="hidden" name="propertyOptions17" value="">
			Property #17 Trackable: False<br>
			<input type="hidden" name="propertyTracking17" value="false"><br>
			<button type="button" onclick="addPropertyItem(18);" id="addPropertyButton" >Add property</button><br><br>
